...
##                                                          ##
##         Multi-species classifier - four test videos      ##
##                                                          ##
##                      Apr 3rd 2023                        ##
##                                                          ##
##############################################################
...
ms_files <- c("Comm_2x_5sp_2_TC.txt", "Comm_2x_5sp_3_TC.txt",
              "Comm_2x_5sp_4_TC.txt")

ms_comtrak_2_4 <- bind_rows(lapply(ms_files, function(x){
...
ms_comtrak <- bind_rows(ms_comtrak1, ms_comtrak_2_4)
...
ggsave(OOB_plot, 
       filename = "output/plots/multi_species/four_videos/OOB_error_multispecies_20230403.jpeg",
...
flextable(test_error) %>% 
  ...
  save_as_image(path = "output/plots/multi_species/four_videos/multispecies_training_test_error.png")
...
ggsave(var_imp_plot, 
       filename = "output/plots/multi_species/four_videos/multispecies_variable_importance.jpeg",
